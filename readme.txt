...
Contributors: Kelsey Damas, Matt Wiebe, Justin Endler, Reid Peifer, Shane Pearlman produced by Shane & Peter, Inc.
...
In October 2011, The Events Calendar 1.6.5 received a long overdue upgrade! We are excited to announce The Events Calendar 2.0. The update fixed a number of bugs that currently impact the unsupported 1.6.5 build, and bring a whole range of new features. For more information please visit http://tri.be or follow us on Facebook at https://www.facebook.com/ModernTribeInc.

The OLD version of the Eventbrite plugin (the one you are looking at) is unsupported and due to changes in the Eventbrite API is no longer functioning. We have rebuilt the plugin and released it in April 2012. Due to the amount of support it requires we will be removing it from the open source and release it as a supported premium add-on to the events calendar. Get a copy here: http://tri.be/shop/wordpress-eventbrite-tickets/.

We have sent a request to the WordPress.org mods to remove this page and are leaving this as a place holder until they get to it. =)
